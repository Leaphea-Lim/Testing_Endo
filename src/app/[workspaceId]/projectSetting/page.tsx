...
import { Copy, AlertTriangle, CircleX } from "lucide-react";
import { ConfirmProjectDialog } from "@/components/popup/confirmProjectDialog";
...
const ProjectSettings = () => {
  ...
  return (
    <div className="mx-12 max-w-4xl p-6 pt-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  className="border-slate-600 bg-slate-900 text-white placeholder:text-slate-500 focus:border-slate-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    readOnly
                    aria-readonly
                    className="flex-1 border-slate-600 bg-slate-900 text-white"
                  />
                  <Button
                    onClick={handleCopy}
                    variant="outline"
